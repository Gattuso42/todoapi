...
//		Mock
//		Request builder
		RequestBuilder getRequest = MockMvcRequestBuilders.get("/todoapi/task/1")
...
//		Sample
//		Request Builder
		RequestBuilder getRequest = MockMvcRequestBuilders.get("/todoapi/task/4");
//		Perform
		mockMvc.perform(getRequest)
				.andExpect(content().contentType(MediaType.APPLICATION_JSON))
...
//		Request Builder
		RequestBuilder putRequest = MockMvcRequestBuilders.put("/todoapi/task/5")
				.content(objectMapper.writeValueAsString(taskTest))
				.contentType(MediaType.APPLICATION_JSON);
//		Perform
		mockMvc.perform(putRequest)
...
//		Sample
//		Request builder
		RequestBuilder putRequest = MockMvcRequestBuilders.put("/todoapi/task/status/14/true")
				.contentType(MediaType.APPLICATION_JSON);
//		Perform
		mockMvc.perform(putRequest)
				.andExpect(status().isOk())
...
//		Sample
//		Request builder
		RequestBuilder putRequest = MockMvcRequestBuilders.put("/todoapi/task/status/5/true")
				.contentType(MediaType.APPLICATION_JSON);
//		Perform
		mockMvc.perform(putRequest)
				.andExpect(status().isNotFound());
